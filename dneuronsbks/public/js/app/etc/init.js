...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			narrow:		{ range: '-980', href: '/assets/css/style-narrow.css', containers: '95%' },
			narrower:	{ range: '-840', href: '/assets/css/style-narrower.css', containers: '95%!'},
			mobile:		{ range: '-736', href: '/assets/css/style-mobile.css', containers: '90%!', grid: { gutters: 20 } },
			mobilep:	{ range: '-480', href: '/assets/css/style-mobilep.css', containers: '100%' }
		},
		plugins: {
			layers: {
				config: {
